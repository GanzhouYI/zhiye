import UIKit
import Alamofire
class CommentDetailController: UIViewController,UITextFieldDelegate,UITextViewDelegate,Comment_Table_Data_Delegate {
    
    var bubbleSection = Array<CommentItem>()
    ...
    var CommentTableView:CommentTableDataView!
    override func loadView() {
        ...
        self.CommentTableView = CommentTableDataView(frame:CGRectMake(0
        ...
        self.CommentTableView.didSelectDelegate = self
