import UIKit
import Alamofire
class FriendTableDataViewCell:UITableViewCell,UITextViewDelegate
{
    var IsMyFriend:Bool!
    ...
    var msgItem:FriendItem!//总体信息对象
    
    init(IsMyFriend:Bool,frame:CGRect,NOCell:Int,data:FriendItem, reuseIdentifier cellId:String)
    {
        ...
        if(msgItem.status == 0 && IsMyFriend != false)
        {
        ...
        else if(msgItem.status == 1 && IsMyFriend != false)
        {
